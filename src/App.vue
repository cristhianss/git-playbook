    ...
    <main>
      <nav class="main__nav" :class="{ active: isNavOpen }">
        <div class="nav__search">
          <input class="nav__search-input" placeholder="tá procurando algo?" v-model="searchKeywords" @keyup="search"/>
      ...
      <div class="container" v-else>
        <h1 class="results__heading" v-if="searchResults.length">{{searchResults.length}} resultados relacionados a "{{searchKeywords}}"</h1>
        <h1 class="results__heading" v-else>Não achei nada relacionada a "{{searchKeywords}}"</h1>
